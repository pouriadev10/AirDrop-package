    ...
    call({ session, name, data, protocol: customProtocol, }) {
        return this.scheduleAction(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const buffers = (0, send_1.createChunks)(bytes, protocol.getChunkHeader(bytes), this.api.chunkSize);
    ...
    send({ data, session, name, protocol }) {
        return this.scheduleAction(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const buffers = (0, send_1.createChunks)(bytes, getChunkHeader(bytes), this.api.chunkSize);
                for (let i = 0; i < buffers.length; i++) {
                    const chunk = buffers[i];
                    yield this.api.write(path, chunk).then(result => {
                        if (!result.success) {
