...
class UdpApi extends abstract_1.AbstractApi {
    ...
    enumerate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const enumerateResult = yield Promise.all(paths.map(path => this.ping(path).then(pinged => pinged ? { path, type: abstract_1.DEVICE_TYPE.TypeEmulator } : undefined))).then(res => res.filter(utils_1.isNotUndefined));
