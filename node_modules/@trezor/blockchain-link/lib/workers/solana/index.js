...
class SolanaWorker extends baseWorker_1.BaseWorker {
    ...
    getTokenMetadata() {
        if (!this.tokenPromise)
            this.tokenPromise = blockchain_link_utils_1.solanaUtils
                .getTokenMetadata()
                .then(tokens => {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                if (yield _super.messageHandler.call(this, event))
                    return true;
                const request = Object.assign(Object.assign({}, event.data), { connect: () => this.connect(), post: (data) => this.post(data), state: this.state, getTokenMetadata: this.getTokenMetadata.bind(this) });
