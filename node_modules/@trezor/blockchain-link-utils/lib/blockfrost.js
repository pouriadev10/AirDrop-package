...
exports.transformAccountInfo = exports.transformTransaction = exports.filterTokenTransfers = exports.transformInputOutput = exports.transformTokenInfo = exports.parseAsset = exports.transformUtxos = void 0;
...
const transformTokenInfo = (tokens) => {
    ...
    const info = tokens.map(token => {
        ...
        return {
            ...
            contract: token.unit,
            symbol: assetName || (0, utils_1.formatTokenSymbol)(token.fingerprint),
    ...
    tx.txUtxos.outputs.forEach(output => {
        output.amount
            ...
            transfers.push({
                ...
                symbol: assetName || (0, utils_1.formatTokenSymbol)(asset.fingerprint),
                contract: asset.unit,
...
const transformTransaction = (blockfrostTxData, addressesOrDescriptor) => {
    ...
    if (outgoing.length === 0 && incoming.length === 0) {
        ...
        if (voutLength) {
            ...
            amount = new bigNumber_1.BigNumber(myInputsSum).minus(totalSpent).minus(fee !== null && fee !== void 0 ? fee : '0');
        }
    }
...
const transformAccountInfo = (info) => {
    ...
    const result = Object.assign(Object.assign({}, info), { tokens: (0, exports.transformTokenInfo)(info.tokens), history: Object.assign(Object.assign({}, info.history), { transactions: !blockfrostTxs
                ? []
                : blockfrostTxs === null || blockfrostTxs === void 0 ? void 0 : blockfrostTxs.map(tx => { var _a; return (0, exports.transformTransaction)(tx, (_a = info.addresses) !== null && _a !== void 0 ? _a : info.descriptor); }) }) });
    return result;
};
